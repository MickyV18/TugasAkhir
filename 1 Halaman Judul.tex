...
\begin{center}
    ...
    {\Large\bfseries\uppercase{\textit{INTEGRASI EXPLAINABLE} AI (XAI) PADA \textit{CORRELATION LEARNING MECHANISM }(CLM) UNTUK DETEKSI TUMOR OTAK MENGGUNAKAN CITRA CT \textit{SCAN}} 
}\\
     \vspace{4cm}
