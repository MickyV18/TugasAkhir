...
\begin{center}
    \vspace{2cm}
  {\large\bfseries \textit{INTEGRASI EXPLAINABLE} AI (XAI) PADA \textit{CORRELATION LEARNING MECHANISM }(CLM) UNTUK DETEKSI TUMOR OTAK MENGGUNAKAN CITRA CT \textit{SCAN}}\\
     \vspace{2cm}
