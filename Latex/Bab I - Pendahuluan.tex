...
% --- Tujuan ---
\section{Tujuan}
Tujuan utama dari tugas akhir ini adalah mengembangkan dan mengevaluasi arsitektur \textit{deep learning} yang dapat mendeteksi keberadaan tumor otak pada citra \textit{CT Scan} secara akurat sekaligus transparan. Kriteria keberhasilan dari tugas akhir ini diukur melalui dua aspek utama: (1) tercapainya performa klasifikasi model yang terukur secara kuantitatif melalui metrik evaluasi seperti akurasi, presisi, dan \textit{recall}, serta (2) dihasilkannya visualisasi XAI sehingga model tidak lagi bertindak sebagai \textit{black box}. Adapun tujuan dari pelaksanaan tugas akhir ini adalah:
...
\begin{enumerate}
	...
	\item Tugas akhir ini menggunakan data gambar otak dengan bidang \textit{axial}.
